...
// const CustomerInfo: React.FC<CustomerInfoProps> = ({ contact, onContactClosed }) => {
...
//     onSuccess: (data, waId) => {
//       console.log('✅ Chat cerrado exitosamente:', waId);
...
//             }}
//           >
//             {closeChatMutation.isPending ? 'Cerrando...' : 'Cerrar'}
//           </ActionButton>
//           {/* <ActionButton
//             variant="outlined"
//             size="small"
